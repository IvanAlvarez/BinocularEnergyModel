...
Parameters.Stim.RandotDotRadius = round(Parameters.Stim.RandotDotRadius);
    ...
    case 'randot'
        ...
        for i = 1 : numel(ga)
            ...
            [Stimulus.ImL(:,:,:,a,f), Stimulus.ImR(:,:,:,a,f)] = BEM_stim_randot(...
                Aperture(:,:,a), ...
                Parameters.Stim.Disparity, ...
                Parameters.Stim.RandotDotRadius, ...
                Parameters.Stim.RandotDotNum, ...
                Parameters.Stim.RandotDotColor, ...
                Parameters.Stim.RandotBackground);
